...
import { Listener, MetadataListener, MessageListener, StatusListener, InterceptingListener, MessageContext } from '.pnpm/@grpc+grpc-js@1.14.0/node_modules/@grpc/grpc-js/build/src/call-interface';
...
import { CallOptions } from '.pnpm/@grpc+grpc-js@1.14.0/node_modules/@grpc/grpc-js/build/src/client';
