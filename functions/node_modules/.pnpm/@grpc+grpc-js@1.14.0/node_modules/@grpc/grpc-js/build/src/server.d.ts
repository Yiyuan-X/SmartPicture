import { Deserialize, Serialize, ServiceDefinition } from '.pnpm/@grpc+grpc-js@1.14.0/node_modules/@grpc/grpc-js/build/src/make-client';
import { HandleCall } from '.pnpm/@grpc+grpc-js@1.14.0/node_modules/@grpc/grpc-js/build/src/server-call';
import { ServerCredentials } from '.pnpm/@grpc+grpc-js@1.14.0/node_modules/@grpc/grpc-js/build/src/server-credentials';
...
import { ServerRef, SocketRef } from '.pnpm/@grpc+grpc-js@1.14.0/node_modules/@grpc/grpc-js/build/src/channelz';
import { ServerInterceptor } from '.pnpm/@grpc+grpc-js@1.14.0/node_modules/@grpc/grpc-js/build/src/server-interceptors';
