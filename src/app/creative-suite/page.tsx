...
import { creativeSuiteJsonLd, creativeSuiteProofPoints } from "@/data/creative-suite";
...
export const metadata = createMetadata({
  title: "创意工作室",
  description:
    "SmartPicture 创意工作室将提示词、参考图与风格预设结合，90 秒生成可投放的商业视觉素材，并支持灵感画廊与团队共享。",
  path: "/creative-suite",
});
...
export default function CreativeSuitePage() {
  return (
    <div className="space-y-16 bg-gradient-to-b from-yellow-50 via-white to-orange-50 pb-20">
      <JsonLd id="creative-suite-json-ld" data={creativeSuiteJsonLd} />
        ...
        <div className="mx-auto max-w-6xl space-y-10 px-4 py-16">
          <div className="space-y-5 lg:space-y-6">
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              {creativeSuiteProofPoints.map((point) => (
