...
import { suggestionCategories, suggestionExamples } from "@/data/suggestions";
...
export function SuggestionsClient() {
  ...
  const [category, setCategory] = useState<string>(suggestionCategories[0]?.value ?? "feature");
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    setTitle("");
    setDescription("");
    setCategory(suggestionCategories[0]?.value ?? "feature");
